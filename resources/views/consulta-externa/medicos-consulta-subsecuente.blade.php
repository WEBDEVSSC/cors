...
@section('content_header')
    <h1><strong>Médicos</strong> <small class="text-muted">Consulta Subsecuente</small></h1>
@stop
...
<div class="card">
    ...
    <form action="{{ route('consultaSubsecuenteStore', $cita->id) }}" method="POST">
        @csrf
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <label for="evolucion">Evolución y Actualización del Cuadro Clínico</label>
                    <textarea name="evolucion" id="evolucion" cols="30" rows="5" class="form-control">{{ old('evolucion') }}</textarea>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-12">
                    <label for="estudios">Estudios de Laboratorio e Imágen</label>
                    <textarea name="estudios" id="estudios" cols="30" rows="5" class="form-control">{{ old('estudios') }}</textarea>
                </div>
