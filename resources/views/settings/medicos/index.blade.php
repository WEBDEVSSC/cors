                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('medicosShow', $medico) }}" class="btn btn-sm btn-info mr-1" data-toggle="tooltip"  title="DETALLES">
                                    ...
                                    <a href="{{ route('medicosEdit', $medico) }}" class="btn btn-sm btn-warning mr-1" data-toggle="tooltip" title="EDITAR">
                                        <i class="fa-solid fa-edit text-white"></i>
                                    </a>

                                    @if ($medico->status == 1)

                                    <form action="{{ route('medicosDestroy', $medico) }}" method="POST" class="form-delete">
                                        @csrf
                                        @method('PUT')
                                        
                                        <input type="hidden" name="status" value="0">

                                        <button type="submit" class="btn btn-sm btn-success" data-toggle="tooltip" title="SUSPENDER">
